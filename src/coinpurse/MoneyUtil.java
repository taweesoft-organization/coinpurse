...
/**
 * Some utility methods for practice using Lists and Comparator.
 */
public class MoneyUtil {

	/**
	 * Examines all the coins in a List and return only the coins
	 * that have a currency that matches the parameter (currency) value.
	 * @param money is a List of Coin objects. This list is not modified.
	 ...
	 */
	public static List<Coin> filterByCurrency(final List<Coin> money, String currency) {
